...
## Does attire have an affect on the rating in each state? 
...
<div style="border:1px grey solid; padding:5px;">
    ...
    <div><h5>Attire</h5>
        <input id="arg2" type="text" value="casual"/>
    </div>
...
function viz(arg1, arg2, arg3){  
    ...
    filtered =  _.filter(items, function(d){
        return (d.state == arg1 && d.attributes && d.attributes.Attire && d.attributes.Attire == arg2)
    }) 
